...
float depositedEnergy_2nd_Sect_FibresCorners;
  ...
  float depositedEnergyCell19 ;
  float depositedEnergyCell20 ;
  float depositedEnergyCell21 ;
  float depositedEnergyCell22 ;
  float depositedEnergyCell23 ;
  float depositedEnergyCell24 ;
  ...
  float depositedEnergyAbove;
  float depositedEnergyBelow;
  float depositedEnergyAbove_1st_Sect;
