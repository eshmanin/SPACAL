...
this->GetTree ()->Branch ("depositedEnergyBelow_1st_Sect",     &this->depositedEnergyBelow_1st_Sect,          "depositedEnergyBelow_1st_Sect/F") ;
this->GetTree ()->Branch ("depositedEnergyAbove_2nd_Sect",     &this->depositedEnergyAbove_2nd_Sect,          "depositedEnergyAbove_2nd_Sect/F") ;
this->GetTree ()->Branch ("depositedEnergyBelow_2nd_Sect",     &this->depositedEnergyBelow_2nd_Sect,          "depositedEnergyBelow_2nd_Sect/F") ;
...
depositedEnergyAbove_1st_Sect = 0.;
depositedEnergyAbove_2nd_Sect = 0.;
depositedEnergyBelow_1st_Sect = 0.;
depositedEnergyBelow_2nd_Sect = 0.;
  ...
  */
  ...
  depositEnergyX->clear () ;
  depositEnergyY->clear () ;
  depositEnergyZ->clear () ;
